...
export class Navigation {
  ...
  addNavigationTooltips() {
    ...
    try {
      ...
      if (!sidebar) {
        console.warn(
          '⚠️ Desktop sidebar not found for navigation tooltips, retrying in 100ms...'
        );
        setTimeout(() => {
          this.addNavigationTooltips();
        }, 100);
      ...
      navTooltips.forEach((item) => {
        ...
        console.log(
          `🔍 Looking for elements with href="/${item.id}.html":`,
          elements.length
        );
  ...
  setupTooltips() {
    try {
      ...
      tooltipManager.addDynamicTooltip(
        'a[href="/dashboard.html"]',
        'ダッシュボード：ワークアウトの統計情報と推奨事項を表示します。',
        {
          position: 'right',
          maxWidth: 350,
          minWidth: 250,
      ...
      tooltipManager.addDynamicTooltip(
        ...
        'プログレッシブ・オーバーロード：筋力向上の進捗を科学的に追跡します。',
        {
          position: 'right',
          maxWidth: 350,
          minWidth: 250,
      ...
      tooltipManager.addDynamicTooltip(
        ...
        'エクササイズデータベース：豊富なエクササイズ情報を検索できます。',
        {
          position: 'right',
          maxWidth: 350,
          minWidth: 250,
      ...
      tooltipManager.addDynamicTooltip(
        '#mobile-menu-btn',
        'メニューを開く：モバイル用のナビゲーションメニューを表示します。',
        {
          position: 'bottom',
        }
      );
      ...
      tooltipManager.addDynamicTooltip(
        '#user-avatar',
        'ユーザープロフィール：アカウント情報とログアウトオプションを表示します。',
        {
          position: 'bottom',
        }
      );
      ...
      tooltipManager.addDynamicTooltip(
        '#login-btn',
        'ログイン：アカウントにログインしてアプリケーションを使用します。',
        {
          position: 'bottom',
        }
      );
      ...
      tooltipManager.addDynamicTooltip(
        ...
        'メニューを閉じる：モバイル用のナビゲーションメニューを閉じます。',
        {
          position: 'bottom',
        }
      );
