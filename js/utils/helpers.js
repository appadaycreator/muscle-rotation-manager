...
export function getWorkoutColor(workoutName) {
    if (workoutName.includes('背筋') || workoutName.includes('back')) {return 'back-color';}
    if (workoutName.includes('肩') || workoutName.includes('shoulder')) {return 'shoulder-color';}
    if (workoutName.includes('腕') || workoutName.includes('arm')) {return 'arm-color';}
    if (workoutName.includes('脚') || workoutName.includes('leg')) {return 'leg-color';}
    if (workoutName.includes('体幹') || workoutName.includes('core')) {return 'core-color';}
    return 'chest-color';
}
 ...
 */
export function createCalendarModalHTML(dateStr, workouts, plannedWorkouts = []) {
                    ...
                    ${workouts.map(workout => `
                        <div class="bg-gray-50 rounded-lg p-4 border-l-4 border-green-500">
                            ...
                            <div class="text-sm text-gray-600 mb-2">
                                ...
                                部位: ${Array.isArray(workout.muscle_groups) ?
