...
export class Validator {
    ...
    static exerciseName(exerciseName) {
        const result = Validator.safeText(exerciseName, VALIDATION_RULES.EXERCISE_NAME_MAX_LENGTH);
...
export class FormValidator {
    ...
    validateWorkoutForm(formData) {
        ...
        const sanitizedData = {
            ...
            notes: this.validateField('notes', formData.notes, (value) => Validator.safeText(value))
        };
...
export class RealtimeValidator {
     ...
     */
    setupFieldValidation(inputElement, errorElement, validator, debounceMs = 300) {
    ...
    setupAuthFormValidation(formElement) {
        ...
        const passwordInput = formElement.querySelector('#auth-password, #signup-password');
    ...
    setupWorkoutFormValidation(formElement) {
        ...
        const exerciseNameInput = formElement.querySelector('[name="exerciseName"]');
        ...
        this.setupFieldValidation(notesInput, null, (value) => Validator.safeText(value));
    }
}

// グローバルバリデーターインスタンス
export const globalFormValidator = new FormValidator();
export const globalRealtimeValidator = new RealtimeValidator(globalFormValidator);
