...
export const MUSCLE_GROUPS = [
    ...
    },
    {
        ...
        category: 'large',
        scientificBasis:
      '大腿四頭筋・ハムストリングは大筋群のため、完全回復に72時間必要'
    },
    {
        id: 'core',
        name: '体幹',
...
export const EXERCISES = {
    ...
    // 自重エクササイズ
        ...
        },
        {
            ...
            name: 'パイクプッシュアップ',
            category: 'compound',
            description: '肩と上部胸筋を鍛える',
            muscles: '大胸筋上部、三角筋前部・中部',
            difficulty: '中級',
            equipment: 'bodyweight'
        },
        {
    ...
    // 自重エクササイズ
        {
            ...
            name: 'プルアップ',
            category: 'compound',
            description: '背筋の王道エクササイズ',
            muscles: '広背筋、上腕二頭筋、三角筋後部',
            difficulty: '上級',
        ...
        },
        {
            ...
            name: 'インバーテッドロウ',
            category: 'compound',
            description: '水平に引く背筋エクササイズ',
            muscles: '広背筋、菱形筋、上腕二頭筋',
            difficulty: '初級',
            equipment: 'bodyweight'
        },
        {
        ...
        // 器具を使ったエクササイズ
        {
            ...
            name: 'デッドリフト',
            category: 'compound',
            description: '全身を鍛えるキングオブエクササイズ',
            muscles: '広背筋、脊柱起立筋、臀筋、ハムストリング',
            difficulty: '上級',
            equipment: 'barbell'
        },
        {
        ...
        },
        {
            ...
            name: 'グッドモーニング',
            category: 'compound',
            description: '腰部と臀筋に効果的',
            muscles: '脊柱起立筋、臀筋、ハムストリング',
            difficulty: '中級',
            equipment: 'barbell'
        }
    ],
    ...
    // 上腕二頭筋
        ...
        {
            id: 51,
            name: 'ケーブルトライセッププッシュダウン',
            category: 'isolation',
            description: 'ケーブルで三頭筋を鍛える',
            muscles: '上腕三頭筋',
            difficulty: '初級',
            equipment: 'cable'
        },
    ...
    // 大腿四頭筋
        ...
        },
        {
            ...
            name: 'グッドモーニング',
            category: 'compound',
            description: '前傾で行うハムストリングエクササイズ',
            muscles: 'ハムストリング、臀筋、脊柱起立筋',
            difficulty: '中級',
            equipment: 'barbell'
        },
