  ...
  describe('GitHub Pages環境での動作確認', () => {
    test('GitHub PagesのURLで正常に動作する', async () => {
      ...
      const githubPagesUrl =
        'https://appadaycreator.github.io/muscle-rotation-manager/';
      ...
      try {
        ...
        // ナビゲーションリンクをテスト
        const navLinks = await page.$$eval('nav a[href$=".html"]', (links) =>
